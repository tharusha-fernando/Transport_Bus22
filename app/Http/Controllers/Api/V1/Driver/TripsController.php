...
use App\Http\Requests\Driver\UpdateTripLocationRequest;
...
class TripsController extends Controller
{
    ...
    public function update_status_(UpdateTripStatusRequest $request, Trip $trip)
    {
        ...
        try {
            ...
            return response()->json(['General Exeption = ', $mn->getMessage()], 500);
        }
    }

    public function SetLocation(UpdateTripLocationRequest $request, Trip $trip)
    {
